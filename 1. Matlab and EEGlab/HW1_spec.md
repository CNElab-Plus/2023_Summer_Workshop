# Matlab and EEGlab tutorial (Homework 1)
...
## Assignment 1: MATLAB Arithmetic and Type Conversion

For the first assignment, you'll need to demonstrate your understanding of basic arithmetic operations and type conversion in MATLAB. You should include addition, subtraction, multiplication, and division operations, as well as examples of converting between different data types.

## Assignment 2: Plotting with Subplots and Tiledlayout in MATLAB

This assignment requires you to create several types of plots using `subplot` and `tiledlayout` in MATLAB. Your submission should include:
...
## Assignment 3: Reading and Writing Files in MATLAB
